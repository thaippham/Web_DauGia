        ...
        <div style={{minHeight: '100vh', width: '100%',
            ...
            <div className='createItemPage'>
                ...
                >
                    ...
                    {"Tùy chọn, bạn cũng có thể cung cấp vị trí chính xác"}
                    </DialogTitle>
                    <DialogContent>
                        <DialogContentText id="alert-dialog-description">
                            ...
                            { (Object.keys(coordinates).length > 0 ) &&
                                ...
                                Đặt thành:&nbsp;&nbsp;{ConvertDMS(coordinates.lat, coordinates.lng)}
                            </Typography> 
                            }
                        </DialogContentText>
                    </DialogContent>
                ...
                {( Object.keys(coordinates).length > 0 ) &&
                    <div style={{color: '#00C9FF'}} >Tọa độ được đặt thành: {coordinates.lat}, {coordinates.lng}</div>
                }
