...
function Users() {
  ...
  return (
    <>
      ...
      <div className="container">
        <Header text="Nhấp vào hồ sơ người dùng để biết thêm chi tiết" />
      </div>

      <div className="container">
        <button className='buttonito' onClick={handleOpen}>Kiểm tra</button>
        <div className="container">
      ...
      >
        ...
        <Box sx={style}>
          <div className='headerito'>
            <headerito>Người dùng đang chờ xác nhận</headerito>
          </div>
          ...
          <button className='buttonito' onClick={handleApprove}>phê duyệt</button>
        </Box>
