...
export default function ConfirmPayment(props) {
  ...
  return (
    ...
    <div>
      <button className="buttonitoMail" onClick={handleClickOpen}> Xác nhận thanh toán</button>
      <Dialog
        open={open}
        onClose={handleClose}
      ...
      >
        <DialogTitle id="alert-dialog-title" style={{
          ...
          {"Trải nghiệm của bạn với người mua như thế nào?"}
        </DialogTitle>
        <DialogContent>
      ...
      <Modal
        ...
        >
          ...
          Ngoài đánh giá, bạn cũng có thể đưa ra phản hồi trực tiếp hơn cho người mua! Ý kiến của bạn rất quan trọng!</Typography>
          </Box>
        </Modal>
    </div>
  );
