...
export default function CreateCoordinates(props) {
  ...
  return (
    <div>
      <button className='buttonitoInfo' onClick={handleOpen}>Thêm tọa độ</button>
      <Modal
        open={open}
        onClose={handleClose}
      ...
      >
        <Box sx={style}>
          ...
          Chọn vị trí chính xác của bạn trên bản đồ
          </Typography>
          <br />
          ...
          <br />
          <button className='buttonitoInfo' onClick={()=>{hehe()}}>Định vị tôi</button>
          <button className='buttonito' onClick={()=>{confirmCoordinates()}}>Xác nhận vị trí</button>
