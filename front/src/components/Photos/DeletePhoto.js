  ...
  return (
    <div>
      {props.images.length>0 &&
          <button className='buttonitoInfo' onClick={handleOpen}>Xóa ảnh</button>
      }
      ...
      >
        <Box sx={style}>
          ...
          <Typography sx={{fontFamily: 'Futura'}} variant="h2" component="h2">Xóa ảnh</Typography>
          <br />
          <DisplayPhotos images={props.images} setSelectedImage={setSelectedImage} />
          <br />
          <Typography sx={{fontFamily: 'Futura'}} variant="h7" component="h2">Bạn có muốn xóa bức ảnh này không?</Typography>
          <br />
