  ...
  return (
    ...
    >
      <Box sx={style}>
        ...
        Chọn một hoặc nhiều bộ lọc
        </Typography>
        <Typography variant="h6" id="modal-modal-description" sx={{ mt: 2 }}>
          Phạm vi giá <PriceRange max={props.max} setPriceRange={setInterPriceRange} />
        </Typography>  
        ...
        <br />
        <br />
        <button className='buttonitoInfo' onClick={()=>{applyFilters()}}>Áp dụng</button>
      </Box>
    </Modal>
    </div>
  );
